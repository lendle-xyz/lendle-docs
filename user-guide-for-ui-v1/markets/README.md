...
* See how much APY/APR a certain market yields
  * The APY/APR is split into 2 numbers
    * The first one being the APY that is either being paid (borrow) or given (supply) in lendle native assets [Broken link](broken-reference "mention"). The amount depends on the market size and protocol fees generated. [#revenue-share](../../overview/lend-token-lendle-2.0.md#revenue-share "mention")
